import { adjustFooterPosition, adjustFootnotes, adjustFootnoteReferences } from './layout.js';
...
function handleFootnoteInput(evt) {
  ...
  adjustFootnoteReferences(contentElement);
}
...
function isCursorInFootnoteRef() {
  ...
  const { endContainer } = getSelectionRange();
